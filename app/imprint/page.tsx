  ...
  return (
    <div className="min-h-screen bg-bg-primary pt-32 pb-20">
      <Container size="sm">
        ...
        <h1 className="text-4xl font-bold text-text-primary mb-12">Impressum</h1>
        ...
        <div className="border-t border-white/10 pt-12">
          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <p className="text-text-secondary leading-relaxed">
                The contents of these pages were created with the utmost care. However,
                I cannot guarantee the accuracy, completeness, or timeliness of the
                content. As a service provider, I am responsible for my own content on
                these pages in accordance with general laws pursuant to § 7 (1) TMG.
                However, according to §§ 8 to 10 TMG, I am not obligated to monitor
              ...
              <p className="text-text-secondary leading-relaxed">
                ...
                content of which I have no influence over. Therefore, I cannot assume
                any liability for this third-party content. The respective provider or
