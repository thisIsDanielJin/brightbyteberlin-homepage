  ...
  return (
    <section id="about" style={{ padding: "112px 56px", background: C.surface, borderBottom: `1px solid ${C.hair}` }}>
      <div style={{ display: "grid", gridTemplateColumns: "300px 1fr", gap: 48, alignItems: "flex-start" }}>
        <div>
          <div style={{ aspectRatio: "1/1", borderRadius: 16, overflow: "hidden", border: `1px solid ${C.hair}`, background: "#ddd" }}>
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/daniel-profile.jpg" alt="Daniel Jin Wodke" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
          </div>
        </div>
        <div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 20, marginTop: 32, paddingTop: 24, borderTop: `1px solid ${C.hair}` }}>
            {([["Based in", "Berlin · CET"], ["Languages", "EN · DE"], ["Background", "6 yrs agencies + SAP"], ["Founded", "2024"]] as const).map(([k, v]) => (
              <div key={k}>
